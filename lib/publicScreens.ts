...
export const PUBLIC_SCREENS: PublicScreen[] = [
  ...
  {
    slug: "growing-stocks-near-52-week-lows",
    title: "Growing stocks near 52-week lows",
    query: "Companies with positive revenue growth trading more than 20% below their 52-week highs",
    summary: "A pullback screen for companies that are still growing revenue while their share prices sit well below recent highs.",
    criteria: ["Positive revenue growth", "At least 20% below the 52-week high", "No recommendation layer"],
    category: "pullback",
  },
  {
  ...
  {
    slug: "growing-stocks-with-momentum",
    title: "Growing stocks with momentum",
    query: "Companies with positive revenue growth, positive one-week performance, and within 10% of their 52-week highs",
    summary: "Looks for revenue growth alongside recent price strength instead of relying on momentum alone.",
    criteria: ["Positive revenue growth", "Positive one-week price change", "Within 10% of 52-week high"],
    category: "momentum",
  },
  {
  ...
  {
    slug: "high-yield-value-stocks",
    title: "High-yield value stocks",
    query: "Dividend stocks yielding over 3% with a P/E under 20",
    summary: "An income screen that combines dividend yield with a simple earnings-valuation ceiling.",
    criteria: ["Dividend yield above 3%", "P/E below 20", "Transparent filter interpretation"],
    category: "income",
  },
  {
    slug: "large-cap-value-stocks",
    title: "Large-cap value stocks",
    query: "Large companies with a P/E under 18 and price-to-book under 4",
    summary: "A broad value screen using two common valuation measures rather than a single ratio.",
    criteria: ["Large market capitalization", "P/E below 18", "Price-to-book below 4"],
    category: "value",
  },
  {
    slug: "growing-tech-on-a-pullback",
    title: "Growing technology stocks on a pullback",
    query: "Technology companies with positive revenue growth more than 15% below their 52-week highs",
    summary: "Narrows pullback hunting to technology companies that are still growing revenue.",
    criteria: ["Technology sector", "Positive revenue growth", "At least 15% below 52-week high"],
    category: "pullback",
  },
  {
    slug: "low-price-to-sales-growth-stocks",
    title: "Growth stocks with lower price-to-sales ratios",
    query: "Companies growing revenue more than 10% with a price-to-sales ratio under 5",
    summary: "Combines positive top-line growth with a cap on the price investors are paying for each dollar of sales.",
    criteria: ["Revenue growth above 10%", "Price-to-sales below 5", "Editable thresholds"],
    category: "growth",
  },
  {
  ...
  {
    slug: "low-pe-growing-stocks",
    title: "Growing stocks with low P/E ratios",
    query: "Companies with positive revenue growth and a P/E below 12",
    summary: "A compact value screen that requires positive revenue growth alongside a low earnings multiple.",
    criteria: ["Positive revenue growth", "P/E below 12", "Ranked by valuation if desired"],
    category: "value",
  },
  {
    slug: "dividend-growth-candidates",
    title: "Dividend growth candidates",
    query: "Dividend stocks yielding over 2% with positive revenue growth and beta below 1.2",
    summary: "Looks for dividend-paying companies that are still growing revenue without unusually high historical volatility.",
    criteria: ["Dividend yield above 2%", "Positive revenue growth", "Beta below 1.2"],
    category: "income",
  },
  {
  ...
  },
  {
    ...
    query: "Large-cap stocks up more than 3% this week with RSI above 55",
    summary: "Combines recent weekly price strength with an above-neutral RSI reading.",
    criteria: ["Large market capitalization", "One-week change above 3%", "RSI above 55"],
    category: "momentum",
  },
  {
  ...
  {
    slug: "steady-growers-on-a-pullback",
    title: "Steady growers on a pullback",
    query: "Companies growing revenue more than 5%, with beta below 1.2, that are at least 10% below their 52-week highs",
    summary: "Combines continued revenue growth, moderate historical volatility, and a meaningful price pullback.",
    criteria: ["Revenue growth above 5%", "Beta below 1.2", "At least 10% below 52-week high"],
    category: "quality",
  },
  {
