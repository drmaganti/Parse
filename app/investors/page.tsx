...
export const metadata: Metadata = {
  ...
  description: "Explore public investor portfolios and screen their reported holdings in plain English with Parse.",
