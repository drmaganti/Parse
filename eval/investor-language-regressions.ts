...
const cases: Case[] = [
  ...
  { name: "growth style remains qualitative", query: "Growth stocks with low debt", absentFields: ["revGrowth", "revGrowth3Y", "debtEquity"], assumption: /growth.*style|growth.*metric|growth.*threshold/i },
