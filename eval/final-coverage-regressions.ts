...
const blindCases: BlindCase[] = [
  ...
  { id: "E01", query: "Large-cap semiconductors with forward P/E below 28, PEG under 1.8, gross margin above 45%, and 3-year revenue CAGR over 12%.", expected: [f("marketCap", ">", 100), f("forwardPe", "<", 28), f("peg", "<", 1.8), f("grossMargin", ">", 45), f("revGrowth3Y", ">", 12), f("sector", "==", "Technology")] },
  { id: "E11", query: "Large healthcare companies with gross margin above 50%, ROE above 20%, 3Y revenue CAGR above 10%, debt/equity below 0.5.", expected: [f("marketCap", ">", 100), f("grossMargin", ">", 50), f("roe", ">", 20), f("revGrowth3Y", ">", 10), f("debtEquity", "<", 0.5), f("sector", "==", "Healthcare")] },
