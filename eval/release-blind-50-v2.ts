...
const cases: C[] = [
  ...
  { id:"U17", cohort:"everyday", q:"Large software companies with revenue growth over 15% and forward P/E under 25.", e:[x("marketCap",">",100),x("sector","==","Technology"),x("revGrowth",">",15),x("forwardPe","<",25)] },
  { id:"U18", cohort:"everyday", q:"Large healthcare companies with ROE above 15% and debt/equity under 0.6.", e:[x("marketCap",">",100),x("sector","==","Healthcare"),x("roe",">",15),x("debtEquity","<",0.6)] },
